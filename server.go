...
type SecretSource interface {
	RADIUSSecret(ctx context.Context, remoteAddr net.Addr, raw []byte) ([]byte, error)
}
...
func (s *staticSecretSource) RADIUSSecret(ctx context.Context, remoteAddr net.Addr, raw []byte) ([]byte, error) {
	return s.secret, nil
}
